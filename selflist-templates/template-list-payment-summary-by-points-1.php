      ...
      <div class="col-sm-12">
        ...
        <section class="payment-display-box text-center p-4">
          <h6 class="text-uppercase"><small class="font-weight-bold">Your List will be published for:
              ...
              class="font-weight-bold">Days</small>
          </h6>
          ...
          <p class="text-uppercase"><small class="font-weight-bold">Your Payment Points (1 day x 1 point):
              &nbsp;</small><span class="list-payment-points text-danger font-weight-bold">_______</span> <small
              class="font-weight-bold">Points</small>
          </p>
        </section>
      </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-uppercase"><small class="font-weight-bold">Your Current Points:
            &nbsp;</small><span id="confirm-current-points" class="text-danger font-weight-bold">_______</span> <small
            class="font-weight-bold"></small>
        </p>
...
<div class="modal fade text-center" id="the-payment-fail-modal" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header justify-content-center bg-dark">
        <h5 class="modal-title" id="exampleModalLabel">Payment Failure!</h5>
        <!-- <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button> -->
      </div>
